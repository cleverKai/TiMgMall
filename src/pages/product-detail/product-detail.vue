<template>
      <div class="product-detail">
           <header class="detail-nav">
             ...
             <div class="nav-list">
               <span :class="{'active' :navIndex ===0}" data-type="product">
                  <i class="iconfont  icon-locationfill" v-show="navIndex===0"></i>
                 商品
               </span>
               <span data-type="detail" :class="{'active':navIndex===1}">
               <i class="iconfont  icon-locationfill" v-show="navIndex===1"></i>
                 商品详情
               </span>
               <span data-type="recommend" :class="{'active':navIndex===2}">
                 <i class="iconfont icon-locationfill" v-show="navIndex===2"></i>
                 商品推荐
               </span>
             </div>
...
<!--        加入购物车-->
        ...
        <transition name="slide-up">
          <section class="cart-wrap" v-show="cartShow">
            ...
            <div class="cart-head">
              <img :src="subImageList[0].imgUrl" v-if="subImageList.length >0" alt="">
              <div>
                <span class="price">￥{{ productData.price }}</span>
                <p>{{ productData.name }}</p>
              </div>
              <i class="iconfont icon-baseline-close-px" @click="closeCart"></i>
            </div>
